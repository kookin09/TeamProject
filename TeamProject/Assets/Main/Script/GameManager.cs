...
public class GameManager : MonoBehaviour
{
    ...
    public void EndGame()
    {
        ...
        Debug.Log("저장:" + uiManager.highScore);
        SaveData();
        ...
        uiManager.highScore = highscore_save;
        Debug.Log("불러오기:" + uiManager.highScore);
        LoadData();
        uiManager.ShowScore();
    ...
    {
        score_save = uiManager.score;
        gold_save = uiManager.gold; 
        highscore_save = uiManager.highScore;
    }
    private void LoadData()
    {
        uiManager.score = score_save;
        uiManager.gold = gold_save;
        uiManager.highScore = highscore_save;
    }
